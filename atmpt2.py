...
class AppDynamicsJob(unittest.TestCase):
    ...
    def test_app_dynamics_job(self):
        driver = self.driver
        driver.get("https://www.centris.ca/en/login?returnUrl=%2f")
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Broker login'])[1]/following::div[5]").click()
        driver.find_element_by_name("loginradius-login").click()
        ...
        driver.find_element_by_link_text("My searches").click()
